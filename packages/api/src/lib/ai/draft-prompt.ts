...
- If the image contains no fashion/clothing item: {"title": "Item", "brand": "", "category_leaf": "", "colour": "", "description": "Could not identify a fashion item in the photos.", "confidence": 0.0}`;
