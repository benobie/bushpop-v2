...
| `RESEND_API_KEY`, `ANTHROPIC_API_KEY`, `SENTRY_DSN`                                            | Optional (graceful fallback)                                                            | Ben (skippable for first deploy — mock email / enrichment off / no error tracking)                                                                                                                                               |
...
| `enrichment`                  | on-demand             | AI enrichment on image upload (ANTHROPIC_API_KEY gated)                                                                                                                      |
