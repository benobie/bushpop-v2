...
const READY_PATHS: { path: string; priority: number }[] = [
  ...
  { path: "/guides/op-shops-brisbane/", priority: 0.7 },
  { path: "/guides/op-shops-perth/", priority: 0.7 },
  { path: "/guides/op-shops-adelaide/", priority: 0.7 },
  { path: "/guides/op-shops-gold-coast/", priority: 0.7 },
  ...
  { path: "/guides/op-shops-townsville/", priority: 0.7 },
  { path: "/guides/op-shops-toowoomba/", priority: 0.7 },
  { path: "/guides/op-shops-ballarat/", priority: 0.7 },
  { path: "/guides/op-shops-bendigo/", priority: 0.7 },
  { path: "/guides/op-shops-launceston/", priority: 0.7 },
  { path: "/guides/op-shops-ipswich/", priority: 0.7 },
  { path: "/guides/op-shops-rockhampton/", priority: 0.7 },
  { path: "/guides/op-shops-mackay/", priority: 0.7 },
  { path: "/guides/op-shops-bundaberg/", priority: 0.7 },
  { path: "/guides/op-shops-wagga-wagga/", priority: 0.7 },
